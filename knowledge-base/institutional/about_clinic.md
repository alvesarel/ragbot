...
language: both
tags: [about, history, mission, values]
priority: normal
...
### Nossos Valores
- **Excelencia**: Utilizamos protocolos medicos baseados em evidencias
- **Personalizacao**: Cada paciente e unico, cada tratamento tambem
- **Acompanhamento**: Nao abandonamos nossos pacientes - estamos presentes em cada etapa
- **Transparencia**: Comunicacao clara sobre expectativas e resultados
